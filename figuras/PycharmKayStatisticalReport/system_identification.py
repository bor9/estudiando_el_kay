...
# xticks labels
i = 20
plt.text(i * xmax / (M-1), baseline, '${:.0f}$'.format(i), fontsize=fontsize2, ha='center', va='baseline')
i = 40
plt.text(i * xmax / (M-1), baseline, '${:.0f}$'.format(i), fontsize=fontsize2, ha='center', va='baseline')
...
plt.savefig('system_identification_u2_input.pdf', bbox_inches='tight')
...
plt.savefig('system_identification_inputs.pdf', bbox_inches='tight')
...
plt.savefig('system_identification_outputs.pdf', bbox_inches='tight')
...
plt.savefig('system_identification_impulse_response_mvu.pdf', bbox_inches='tight')
...
i = 0
plt.text(i-yt_sep, baseline, '${}$'.format(i), fontsize=fontsize1, ha='right', va='baseline')
for i in np.arange(0.01, 0.055, 0.01):
...
plt.axis('off')
plt.savefig('system_identification_crlb_mse.pdf', bbox_inches='tight')

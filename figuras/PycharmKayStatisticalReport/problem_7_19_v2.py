...
plt.xlim(0, M-1)
plt.ylim(0.244, 0.258)
plt.plot(Ms, f0_grid, 'k', lw=1)
ax.set_xticklabels([])
plt.text(0.5, 0.86, '$\mathrm{B\\acute{u}squeda\;de\;grilla:\; 500\;valores\;en\;}[0,\,1/2]$', fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)
plt.text(0.5, 1.15, '$\mathrm{Estimaciones\;en\;500\;realizaciones\;con\;cada\;m\\acute{e}todo}$', fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)
...
ax.set_xticklabels([])
plt.text(0.5, 0.84, '$\mathrm{{Newton-Raphson\;con\;valor\;inicial\;}}f_0={:.2f}$'.format(f0i[0]), fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)
...
ax.set_xticklabels([])
plt.text(0.5, 0.84, '$\mathrm{{Newton-Raphson\;con\;valor\;inicial\;}}f_0={:.2f}$'.format(f0i[1]), fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)
...
ax.set_xticklabels([])
plt.text(0.5, 0.84, '$\mathrm{{Newton-Raphson\;con\;valor\;inicial\;}}f_0={:.2f}$'.format(f0i[2]), fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)
...
plt.text(0.5, 0.84, '$\mathrm{{Newton-Raphson\;con\;valor\;inicial\;}}f_0={:.2f}$'.format(f0i[3]), fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)
plt.text(0.5, -0.4, '$\mathrm{N\\acute{u}mero\;de\;realizaci\\acute{o}n\;(}M\mathrm{)}$', fontsize=fontsize,
         ha='center', va='center', transform=ax.transAxes)


# save as pdf image
plt.savefig('problem_7_19_estimations_v2.pdf', bbox_inches='tight')
